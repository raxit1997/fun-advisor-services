export class Config {
    ...
    public static ELASTiC_SEARCH_HOST: string = '999858dfa2244690a4d030c33c4f986f.us-east-1.aws.found.io';
    public static ELASTIC_SEARCH_AUTH: string = 'elastic:GNmWA8ZN7la7QiJ2MOMJNnKm';
